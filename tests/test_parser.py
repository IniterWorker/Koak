...
class ParserTest(ParserCustomTestCase):
    ...
    def test_extern_prototype_ok_2_args(self):
        ...
        self.stdout_expected([
            "FunctionDef(x (x: bool, y: int) -> double)",
        ])
        self.assertKoakListEqual()
        self.assertKoakZeroError()
...
class UnaryOperatorTest(ParserCustomTestCase):
    ...
    def test_basic_neg(self):
        self.stdin_append("-1;")
        self.stdout_expected("TopLevelExpr(Expr(Unary(Sub, IntegerLiteral(1))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()

    def test_basic_neg_chained(self):
        self.stdin_append("--1;")
        self.stdout_expected("TopLevelExpr(Expr(Unary(Sub, Unary(Sub, IntegerLiteral(1)))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()

    def test_basic_pos(self):
        self.stdin_append("+1;")
        self.stdout_expected("TopLevelExpr(Expr(Unary(Add, IntegerLiteral(1))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()
...
class DelimiterTest(ParserCustomTestCase):
    ...
    def test_function_missing_bracket(self):
        self.stdin_append("def fib(x: double) -> double { if x < 3 { 1 } else { fib(x - 1) + fib(x - 2) } ")
        self.assertKoakLastErrorContain("Unterminated block")

    def test_delimiter_multiple_expr_and_empty(self):
        self.stdin_append(";;1+2;;;;;;")
        self.stdout_expected("TopLevelExpr(Expr(Binary(Add, IntegerLiteral(1), IntegerLiteral(2))))")
        self.assertKoakZeroError()
...
class BinOperatorTest(ParserCustomTestCase):
    ...
    def test_basic_div(self):
        self.stdin_append("1 / 2;")
        self.stdout_expected("TopLevelExpr(Expr(Binary(Div, IntegerLiteral(1), IntegerLiteral(2))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()

    def test_basic_mul(self):
        self.stdin_append("1 * 2;")
        self.stdout_expected("TopLevelExpr(Expr(Binary(Mul, IntegerLiteral(1), IntegerLiteral(2))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()

    def test_basic_mod(self):
        self.stdin_append("1 % 2;")
        self.stdout_expected("TopLevelExpr(Expr(Binary(Rem, IntegerLiteral(1), IntegerLiteral(2))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()
    ...
    def test_priority_basic_neg(self):
        ...
        self.stdout_expected(
            "TopLevelExpr(Expr(Binary(Mul, Binary(Rem, IntegerLiteral(1), IntegerLiteral(2)), IntegerLiteral(3))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()
    ...
    def test_priority_basic_add_div(self):
        self.stdin_append("1 + 2 / 3;")
        self.stdout_expected(
            "TopLevelExpr(Expr(Binary(Add, IntegerLiteral(1), Binary(Div, IntegerLiteral(2), IntegerLiteral(3)))))")
        self.assertKoakListEqual()
        self.assertKoakZeroError()
...
class CommentTest(ParserCustomTestCase):
    ...
    def test_comment_catch_delimiter(self):
        self.stdin_append("if true { 1 + 2 # comment }")
        self.assertKoakLastErrorContain("Unterminated block")
...
class DefinitionTest(ParserCustomTestCase):
    ...
    def test_def_fib(self):
        ...
        self.stdout_expected("FunctionDef(fib (x: double) -> double { "
                             "Cond(Binary(Less, Variable(\"x\"), IntegerLiteral(3)), "
                             "{ Expr(IntegerLiteral(1)) }, "  # return 1
                             "{ Expr(Binary(Add, "  # compute big
...
class LiteralTest(ParserCustomTestCase):
    ...
    def test_hexadecimal_const_0xFF(self):
        ...
        self.stdout_expected("TopLevelExpr(Expr(IntegerLiteral({})))".format(int("0xFF", 16)))
        self.assertKoakListEqual()

    def test_hexadecimal_const_0x00(self):
        self.stdin_append("0x00;")
        self.stdout_expected("TopLevelExpr(Expr(IntegerLiteral({})))".format(int("0x00", 16)))
        self.assertKoakListEqual()

    def test_hexadecimal_const_0x11111111(self):
        self.stdin_append("0x11111111;")
        self.stdout_expected("TopLevelExpr(Expr(IntegerLiteral({})))".format(int("0x11111111", 16)))
        self.assertKoakListEqual()
    ...
    def test_integer_limit_32(self):
        ...
        self.stdout_expected("TopLevelExpr(Expr(IntegerLiteral({})))".format(int("0x7FFFFFFF", 16)))
        self.assertKoakListEqual()
        self.assertKoakZeroError()
    ...
    def test_double_one(self):
        ...
        self.stdout_expected("TopLevelExpr(Expr(DoubleLiteral({})))".format("1.0"))
        self.assertKoakListEqual()
        self.assertKoakZeroError()

    def test_double_zero(self):
        self.stdin_append("0.0;")
        self.stdout_expected("TopLevelExpr(Expr(DoubleLiteral({})))".format("0.0"))
        self.assertKoakListEqual()
        self.assertKoakZeroError()
